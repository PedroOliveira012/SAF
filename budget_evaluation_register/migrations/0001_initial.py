    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documentation_comment', models.CharField(
                    max_length=255, null=True)),
                ('material_list', models.CharField(max_length=6)),
                ('material_list_comment', models.CharField(
                    max_length=255, null=True)),
                ...
                ('tecnical_offer_comment', models.CharField(
                    max_length=255, null=True)),
                ('comercial_offer', models.CharField(max_length=6)),
                ('comercial_offer_comment', models.CharField(
                    max_length=255, null=True)),
